		...
		<div class='inner-column'>
			...
			<section class="adventure">
				<div class="item-title">
					...
					<a href="choose-adventure/1.html" target='choose-adventure'>Choose Your Adventure!</a>
				</div>
				...
				<div class="item-content">
					...
					<p>I also used this as an opportunity to use consistent CSS stylesheets throughout the game. There are standard styles, losing styles and winning styles for each! Having one standard stylesheet means that I can easily update multiple pages in one stylesheet.</p>
				</div>
			</section>
			...
			<section class="mock-client">
				<div class="item-title">
					...
					<a href="homebodies" target='homebodies'>Homebodies</a>
				</div>
			...
			<section class="mountains">
				<div class="item-title">
					...
					<a href="layout-challenge" target='layout-challenge'>Layout Challenge</a>
				</div>
			...
			<section class="fell-over">
				<div class="item-title">
					...
					<a href="flexbox-module-fun" target='flexbox-module-fun'>I Fell Over!</a>
				</div>
			...
			<section class="replica">
				<div class="item-title">
					...
					<a href="website-replica" target='replica'>Website Replica</a>
				</div>
